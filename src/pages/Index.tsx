      ...
      <section className="pt-32 pb-20 bg-warm-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-foreground animate-fade-in text-5xl md:text-6xl">
              Social Factory
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-cream/90 leading-relaxed mb-10 max-w-[70ch] mx-auto font-light">
              Europe's own research tells us that loneliness, poor mental health, and disconnection are not personal
